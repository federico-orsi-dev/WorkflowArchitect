...
from app.schemas.plan import PlanResult, PlanTask
        ...
        if isinstance(task_payloads, list):
            for task_payload in task_payloads:
                ...
                if isinstance(risk, str):
                    ...
                    if normalized_risk in ("medium", "mid"):
                        task_data["risk"] = "med"
                    elif normalized_risk in ("low", "med", "high"):
                        task_data["risk"] = normalized_risk
                    else:
                        task_data["risk"] = "med"
                normalized_tasks.append(PlanTask.model_validate(task_data))
